...
4. Click **Save and Continue** through the "Scopes" and "Test users" pages without adding anything yet.

5. On the **Test users** screen, click **+ ADD USERS** and add your own Gmail address (this is required while the app is in "Testing" mode).
...
5. You might see a "Google hasn't verified this app" warning (since you just created it). Click **Advanced** > **Go to Bin Scraper (unsafe)**.
